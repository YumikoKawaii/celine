...
type SigaoRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SigaoRequest) Reset() {
	*x = SigaoRequest{}
...
func (x *SigaoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SigaoRequest) ProtoMessage() {}

func (x *SigaoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_celine_v1_celine_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SigaoRequest.ProtoReflect.Descriptor instead.
func (*SigaoRequest) Descriptor() ([]byte, []int) {
	return file_celine_v1_celine_proto_rawDescGZIP(), []int{5}
}

type SigaoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SigaoResponse) Reset() {
	*x = SigaoResponse{}
...
func (x *SigaoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SigaoResponse) ProtoMessage() {}

func (x *SigaoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_celine_v1_celine_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SigaoResponse.ProtoReflect.Descriptor instead.
func (*SigaoResponse) Descriptor() ([]byte, []int) {
...
const file_celine_v1_celine_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt2\x8c\x02\n" +
	"\x06Celine\x12B\n" +
	"\bParousia\x12\x1a.celine.v1.ParousiaRequest\x1a\x18.celine.v1.ParousiaEvent0\x01\x12:\n" +
	"\x05Pempo\x12\x17.celine.v1.PempoRequest\x1a\x18.celine.v1.PempoResponse\x12:\n" +
	"\x05Sigao\x12\x17.celine.v1.SigaoRequest\x1a\x18.celine.v1.SigaoResponse\x12F\n" +
...
var file_celine_v1_celine_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_celine_v1_celine_proto_goTypes = []any{
	...
	(*SigaoRequest)(nil),          // 5: celine.v1.SigaoRequest
	(*SigaoResponse)(nil),         // 6: celine.v1.SigaoResponse
	(*Message)(nil),               // 7: celine.v1.Message
	(*ToolCall)(nil),              // 8: celine.v1.ToolCall
	(*ToolResult)(nil),            // 9: celine.v1.ToolResult
	(*Done)(nil),                  // 10: celine.v1.Done
	(*AnamnesisRequest)(nil),      // 11: celine.v1.AnamnesisRequest
	(*AnamnesisResponse)(nil),     // 12: celine.v1.AnamnesisResponse
	(*ChatMessage)(nil),           // 13: celine.v1.ChatMessage
	(*timestamppb.Timestamp)(nil), // 14: google.protobuf.Timestamp
}
var file_celine_v1_celine_proto_depIdxs = []int32{
	4,  // 0: celine.v1.ParousiaEvent.typing:type_name -> celine.v1.Typing
	7,  // 1: celine.v1.ParousiaEvent.message:type_name -> celine.v1.Message
	8,  // 2: celine.v1.ParousiaEvent.tool_call:type_name -> celine.v1.ToolCall
	9,  // 3: celine.v1.ParousiaEvent.tool_result:type_name -> celine.v1.ToolResult
	10, // 4: celine.v1.ParousiaEvent.done:type_name -> celine.v1.Done
	13, // 5: celine.v1.AnamnesisResponse.messages:type_name -> celine.v1.ChatMessage
	14, // 6: celine.v1.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	...
	5,  // 9: celine.v1.Celine.Sigao:input_type -> celine.v1.SigaoRequest
	11, // 10: celine.v1.Celine.Anamnesis:input_type -> celine.v1.AnamnesisRequest
	...
	6,  // 13: celine.v1.Celine.Sigao:output_type -> celine.v1.SigaoResponse
	12, // 14: celine.v1.Celine.Anamnesis:output_type -> celine.v1.AnamnesisResponse
